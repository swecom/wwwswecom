...
$maybe_taxonomy = rishi__cb_get_matching_taxonomy('page', false);
...
$options = [
		...
		'page_title_panel' => [
			...
			'inner-options' => [
			 ...
			 rishi__cb_customizer_rand_md5() => [
					'type' => 'rt-condition',
					'condition' => [ 'page_title_hero_section' => 'enabled' ],
					'options' => [
	 ...
	 rishi__cb_customizer_rand_md5() => [
			...
			'options' => [
				 ...
				 rishi__cb_customizer_rand_md5() => [
					...
					'options'   => [
						'single_page_content_background' => [
						...
						'single_page_content_boxed_shadow' => [
						...
						'single_page_boxed_content_spacing' => [
						...
						'single_page_content_boxed_radius' => [
	...
	apply_filters(
		'rishi__cb_customizer_extensions_metabox_page_bottom',
		[]
	)
];
