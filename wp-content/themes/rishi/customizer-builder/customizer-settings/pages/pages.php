...
$options = [
	'page_section_options' => [
		...
		'customizer_section' => 'container',
            'inner-options'      => apply_filters( 'rishi__cb_:pages:inneroptions', [
                'page_title_panel' => [
                    'label'         => __( 'Page Title', 'rishi'),
                    'type'          => 'rt-panel',
                    'switch'        => true,
                    'value'         => 'yes',
                    'inner-options' => apply_filters( 'rishi__cb_:pages:page_title:inneroptions', [
                        'breadcrumbs_ed_single_page' => [
                            'label'   => __('Breadcrumb', 'rishi'),
                            'type'    => 'rara-switch',
                            'value'   => $breaddefaults['breadcrumbs_ed_single_page'],
                        ],
                        $prefix . 'alignment' => [
                            'type'       => 'rt-radio',
              ...
              rishi__cb_customizer_rand_md5() => [
                    ...
                    'type'    => 'tab',
                    'options' => apply_filters( 'rishi__cb_:pages:general_tab:options', [
                        'page_sidebar_layout' => [
                            'label' => __('Sidebar Layout', 'rishi'),
                            'type'    => 'rt-image-picker',
                            'value'   => $defaults['page_sidebar_layout'],
                            'attr'  => [
                                'data-type'    => 'background',
                                'data-usage'   => 'layout-style',
                                'data-columns' => '2',
                            ],
                            'desc' => __('Choose sidebar layout for page.', 'rishi'),
                            'choices' => [
                                'right-sidebar' => [
                        ...
                        'page_layout' => [
                            'label'   => __('Page Layout', 'rishi'),
                            'type'    => 'rt-select',
                            'value'   => $defaults['page_layout'],
                            'view'    => 'text',
                            'design'  => 'inline',
                            'divider' => 'top',
                            ...
                            'desc' => __('Choose page container layout.', 'rishi'),
                        ],
                        'page_layout_streched_ed' => [
                        ...
                        $prefix . 'has_featured_image' => [
                            ...
                            'value'         => 'yes',
                            'inner-options' => [
                              rishi__cb_customizer_get_options( 'single-elements/featured-image', [ 'prefix' => 'single_page' ] )
                            ]
                        ],
                        $prefix . 'ed_comment' => [
              ...
              rishi__cb_customizer_rand_md5( 'rishi__cb:pages:design' ) => [
                    'title'   => __('Design', 'rishi'),
                    'type'    => 'tab',
                    'options' => apply_filters( 'rishi__cb_:pages:design_tab:options', [
                          rishi__cb_customizer_rand_md5() => [
                            'type' => 'rt-condition',
